...
public abstract class MyOrientationEventListener {
    ...
    /**
     * Creates a new MyOrientationEventListener.
     *
     * @param context for the MyOrientationEventListener.
     */
    ...
    /**
     * Enables the MyOrientationEventListener so it will monitor the sensor and call
    ...
    public void enable() {
        ...
        if (mEnabled == false) {
            if (localLOGV) Log.d(TAG, "MyOrientationEventListener enabled");
    ...
    /**
     * Disables the MyOrientationEventListener.
     */
    public void disable() {
        if (mSensor == null) {
        ...
        if (mEnabled == true) {
            if (localLOGV) Log.d(TAG, "MyOrientationEventListener disabled");
